            ...
            return a().wrap(function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  ...
                  case 5:
                    if (((i = t.sent), (c = i.data), !(u = i.errors))) {
                      t.next = 10;
                      break;
                    }
                    throw Error(
                  ...
                  switch ((t.prev = t.next)) {
                    ...
                    case 4:
                      if (
                        ((u = t.sent),
                        !(l =
                          null == u || null === (e = u.errors) || void 0 === e
                            ? void 0
                            : e[0]))
                      ) {
                        t.next = 8;
                    ...
                    case 8:
                      return (
                        c.events.emit(
                          "checkout/data",
                          u.data.setShippingAddressesOnCart.cart
                        ),
                        t.abrupt(
                          "return",
                          u.data.setShippingAddressesOnCart.cart
